...
import rut.miit.consumerservice.repositories.ClientRepository;
...
import rut.miit.consumerservice.services.interfaces.OrderService;
...
public class OrderServiceImpl implements OrderService<String> {
    ...
    public OrderDTO createOrder(OrderDTO orderDTO) {
        ...
        rabbitTemplate.convertAndSend(ApplicationBeanConfiguration.EXCHANGE_NAME, "order.created", savedOrder.getId());
